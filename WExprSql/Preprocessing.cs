...
namespace W.Expressions.Sql
{
    internal static partial class Preprocessing
    {
        ...
        internal static SqlFuncPreprocessingCtx NewCodeLookupDict(SqlFuncPreprocessingCtx src, SqlInfo tmpl, string codeFieldName)
        {
                    ...
                    case SqlSectionExpr.Kind.Select:
                        {
                            ...
                            var tmplInnerAttrs = (Dictionary<Attr.Col, object>[])tmpl.attrs[Attr.Tbl.innerAttrs];
            ...
            Attr.Add(tblAttrs, Attr.Tbl.description, $"Autogenerated description of lookup table for '{codeFieldName}' field");
            tblAttrs[Attr.Tbl.actuality] = c.actualityInDays;
            tblAttrs[Attr.Tbl.arrayResults] = true;
            tblAttrs[Attr.Tbl.innerAttrs] = innerAttrs;
        ...
        internal class PreprocessingContext
        {
            ...
            internal SqlExpr PostProc(SqlFuncPreprocessingCtx c, SqlExpr sql)
            {
                ...
                if (c.tblAttrs.TryGetValue(Attr.Tbl.innerAttrs, out var objInnerAttrs))
                {
                    ...
                    for (int i = 0; i < n; i++)
                    {
                        ...
                        {   // inherit lot of fields from abstract tables
                            ...
                            foreach (var aT in lst)
                            {
                                ...
                                // inherit fields
                                changed = true;
                                if (abstr.attrs.TryGetValue(Attr.Tbl.innerAttrs, out var objInners))
                                {
                    ...
                    if (changed)
                    {
                        ...
                        c.tblAttrs[Attr.Tbl.innerAttrs] = newInner.ToArray();
                    }
                }
