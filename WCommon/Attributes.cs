...
namespace W.Common
{
	...
	public class ValueInfo : IEqualityComparer<ValueInfo>
	{
		...
		public static ValueInfo Create(string descriptor, bool mayReturnNull = false)
		{
			...
			try { return new ValueInfo(parts[1], (parts.Length > 3) ? parts[3] : null, parts[0], (parts.Length > 2) ? parts[2] : string.Empty); }
